...
const socialNetworkList = [
    'clubhouse', 'rumble', 'mewe',
    'gab', 'triller', 'wtsocial',
    'valence', 'flip', 'popbase',
    'elpha', 'yubo', 'peanut',
    'houseparty', 'caffeine', 'steemit',
    'goodreads', 'twitch', 'caringbridge',
    'wattpad', 'crunchyroll', 'soundcloud',
    'mocospace', 'couchsurfing', 'italki',
    'medium', 'ello', 'vimeo',
    'giphy', 'tribe', 'kuaishou',
    'imgur', 'influenster', 'filmaffinity',
    'opendiary', 'bubbly', 'facebook',
    'twitter', 't', 'pinterest', 'lnkd', 'linkedin', 'tumblr',
    'instagram', 'foursquare', 'flickr', 'wattpad',
    'netvibes', 'plurk', 'polyvore',
    'pavlinaspeaks', 'youtube', 'getpocket', 'vk', 'wt'
];
